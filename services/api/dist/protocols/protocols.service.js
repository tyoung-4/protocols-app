...
let ProtocolsService = class ProtocolsService {
    constructor(protocolRepo, versionRepo) {
...
exports.ProtocolsService = ProtocolsService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(Protocol_1.Protocol)),
    __param(1, (0, typeorm_1.InjectRepository)(ProtocolVersion_1.ProtocolVersion)),
